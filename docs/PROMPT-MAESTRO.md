...
Se ha movido a su propio documento: **[`docs/LISTA-RIUNIONE.md`](LISTA-RIUNIONE.md)** (en italiano, 21 puntos).

El análisis de clientes por nacionalidad que respalda varias de esas decisiones está en **[`docs/ANALISI-CLIENTI.md`](ANALISI-CLIENTI.md)**.
